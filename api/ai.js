...
export default async function handler(req, res) {
    ...
    const curriculum = req.body?.curriculum || 'CAPS';
        ...
        const response = await fetch("https://api.deepseek.com/v1/chat/completions", {
            ...
            body: JSON.stringify({
                ...
                messages: [
                    {
                        role: "system",
                        content: `You are ScoreUp, an AI ${curriculum} tutor for South African Grade ${grade} students.
${curriculum === 'IEB' ? 'IEB focuses on research, critical thinking and essay skills. Go deeper in explanations.' : 'Teach strictly according to the CAPS curriculum.'}
${subject ? `The student is currently studying: ${subject}. Stay focused on ${subject} unless they explicitly ask to change subject.` : 'Wait for the student to tell you what subject they are studying.'}
                        ...
                        You must:
                            - Teach according to ${curriculum} curriculum
                    - Use simple English
